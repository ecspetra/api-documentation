    ...
    if (resizeData.tracking) {
      ...
      function hideSidebar() {
        if (sidebar.style.width < "150px") {
          $("#sidebar .sidebar-menu li a.multilevel img").addClass("hidden");
          ...
          $("#sidebar .sidebar-menu li a.multilevel img").removeClass("hidden");
          $("#sidebar .sidebar-menu li a span").removeClass("hidden");
          $("#sidebar .sidebar-menu li a").css("justify-content", "flex-start");
